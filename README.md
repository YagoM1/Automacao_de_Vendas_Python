...
* `Automacao.py`: Script de geração de dados brutos.
* `Analise.py`: Script de inteligência de dados e gráficos.
* `Gerador_de_Relatorio.py`: Script de fechamento e geração de PDF.
